		...
		<div class="container py-4">
			<div class="row">
				<div class="col-12">
					<a href="<?php echo base_url('faculty/admin_create');?>" class=" btn   btn-lg bg-gradient-primary">Add New Member</a> <br>
					<div class="card mb-4">
							...
							<div class="table-responsive p-0">
								...
								<?php if ($usersearch) { foreach ($usersearch as  $value) {?>
									 <tbody>
									   ...
									   <th><?php echo $value['password']?></th>  <th><?php echo $value['department_name']?></th>
