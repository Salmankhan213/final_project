    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
		...
		<div class="form-group has-feedback">
            ...
            <input type="text" class="form-control" value="<?php echo $admin[0]['name']?>" name="name" required />
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="email" class="form-control" value="<?php echo $admin[0]['email']?>" name="email" required />
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="password" class="form-control" value="<?php echo $admin[0]['password']?>" name="password" required />
          ...
          <div class="row">
            ...
            <div class="col-xs-4 m-3">
              <input type="submit" class="btn btn-primary btn-block btn-flat" name="submit" value="Updated" />
            </div><!-- /.col -->
          </div>
        </form>
